...
public class ListViewAdapterProductosEnvv2 extends BaseAdapter implements Filterable {
    ...
    public ListViewAdapterProductosEnvv2(Context context, SDTProductos[] SDTProductos) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final View itemView = inflater.inflate(R.layout.listarproductosenvv2,parent, false);
       ...
       // txt_porval.setText(String.format("%,d",SDTProductos[position].ValorPedidoEnviado.intValue()));
 ...
 //       spinner_causal.setAdapter(new ArrayAdapter<String>(context,R.layout.support_simple_spinner_dropdown_item,CausalNombre)); // simple_spinner_item
        ...
        if(SDTProductos[position].ValorPedidoEnviado>0){
            ...
            txt_porenvio.setText(String.format("%,d",Porcentaje.intValue())+'%');*/
        }else{
        ...
        Btn_Editarprod.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((ResumenPedidoEnvV2) context).startActivityForResult(intent, position);
