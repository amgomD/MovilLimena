...
public class ResumenRecibosDiaSoporte extends AppCompatActivity {
    ...
    ResumenRecibosDiaSoporte CameraActivity = null;
    String dirpath;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resumen_recibos_dia_soporte);
        ...
        try {
            ...
            Cursor cursor = BaseDeDatos.getWritableDatabase().rawQuery("select p.NitSec,p.CliSec,c.NitCom,c.CliNom,sum(abono) abono,sum(retefue) retfue,sum(retica) retica,sum(descuento) retdes,sum(abono-retefue-retica-descuento) efectivo from recibo p left join clientes c on p.nitsec=c.nitsec and p.clisec=c.clisec " +
            ...
            if (cursor.getCount() > 0) {
                ...
                do {
                    ...
                    String NumPed = cursor.getString(0) +  cursor.getInt(1) +  time.year +  (time.month + 1) +  time.monthDay  ;
                 ...
                 //   SDTPedidosEnviadosItem.ValorPedido = GestorPedidos.TotalesPedido(getApplicationContext(), cursor.getString(4), cursor.getString(0), cursor.getInt(1),"","","").Total;
                    SDTPedidosEnviadosItem.sEnviado = GestorPedidos.ReciboEnviado(getApplicationContext(), "", cursor.getString(0), cursor.getInt(1));
            ...
            if(resultCode == Activity.RESULT_OK) {
                try {
                    ...
                    if ( resultCode == RESULT_OK) {
                        ...
                        new ResumenRecibosDiaSoporte.LoadImagesFromSDCard().execute(""+imageId);
    ...
    public class LoadImagesFromSDCard  extends AsyncTask<String, Void, Void> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(ResumenRecibosDiaSoporte.this);
